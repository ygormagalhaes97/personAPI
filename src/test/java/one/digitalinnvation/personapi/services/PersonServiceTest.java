package one.digitalinnvation.personapi.services;
...
import static one.digitalinnvation.personapi.utils.PersonUtils.createFakeDTO;
import static one.digitalinnvation.personapi.utils.PersonUtils.createFakeEntity;
...
public class PersonServiceTest {
    ...
    private MessageResponseDTO createExpectedSuccessMessage(Long savedPersonId) {
        return MessageResponseDTO.builder()
                .message("criado uma pessoa com ID " + savedPersonId)
                .build();
    }
}
